<template>
    <div id="detailContrainer" class="slide-enter-active">
        <Header title="影片详情">
            <i class="iconfont icon-right" @touchstart="handleToBack" @click="handleToBack"></i>
        </Header>
...
export default {
    ...
    mounted(){
		...
		/*
		发送影片详情get请求
		.then()处理get 到的数据,使用(res)=>{}函数处理数据,并判断msg信息是否是接口返回的'ok'
		获取接口信息成功，页面渲染完成，将Loading组件去掉，将接口的影片详情赋值给data的detailMovie
		调用$nextTick回调函数新建一个swiper对象，设置对应的ref相关的dom元素，并配置参数
		*/
